...
const DEFAULT_CONTENT = {
  ...
  plans: [
    { tier: "basic",    name: "Basic",    price: "R$ 497",   priceSub: "pagamento único", tagline: "Ideal para começar rápido e profissional", badge: null, highlighted: false, ctaLabel: "Começar agora", audience: "Autônomos e pequenos negócios", features: ["Landing page profissional","Botão WhatsApp integrado","Copy otimizada para conversão","Mobile-first & responsivo","Entrega em até 7 dias"] },
    { tier: "advanced", name: "Advanced", price: "R$ 1.500", priceSub: "pagamento único", tagline: "Plano mais escolhido — solução completa", badge: "MAIS ESCOLHIDO", highlighted: true, ctaLabel: "Escalar agora", audience: "Empresas locais, lojas e prestadores", features: ["Site completo multi-página","Automação de WhatsApp","Funil de vendas básico","SEO técnico inicial","Painel administrativo","Suporte prioritário 30 dias"] },
