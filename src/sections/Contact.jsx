    ...
    <section id="contact">
      ...
      >
        ...
        <div className={`fade-up ${inView ? 'visible' : ''}`} style={{ maxWidth: '560px' }}>
          ...
          <h2>
            Pronto para{' '}
            <span className="gold-text">começar?</span>
          </h2>
          <p style={{ marginTop: '1rem' }}>
            Agende uma reunião estratégica gratuita de 30 minutos.
            Identificamos as melhores oportunidades de automação e crescimento
          ...
          {SOCIAL.map((s, i) => (
            ...
            >
              ...
              <div>
                ...
                <div className="social-link-value">{s.value}</div>
              </div>
            </a>
          ))}
        </div>
